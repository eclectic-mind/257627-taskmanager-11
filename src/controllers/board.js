...
export default class BoardController {
  constructor(container, tasksModel) {
    ...
    this._showingTasksCount = TASKS_COUNT_ON_START;
  ...
  _renderButton() {
    ...
    this._buttonComponent.setClickHandler(this._onButtonClick);
  }
  ...
  _onDataChange(taskController, oldData, newData) {
    ...
    if (oldData === EmptyTask) {
      ...
      const isSuccess = this._tasksModel.updateOneTask(oldData.id, newData);
  ...
  _onSortTypeChange(sortType) {
    this._showingTasksCount = TASKS_COUNT_BY_BUTTON;
  ...
  _onButtonClick() {
    ...
    const tasks = this._tasksModel.getTasks();
    this._showingTasksCount = this._showingTasksCount + TASKS_COUNT_BY_BUTTON;
  ...
  _onFilterChange() {
    this._updateTasks(TASKS_COUNT_ON_START);
  }
}
